		...
		return this.each(function () {
			...
			var showMeanMenu = function () {
				...
				if (currentWidth <= meanScreenWidth) {
					...
					var html = '<div class="mean-bar">';
					html += '<img src="/sivaseo/images/bg/web-ataturk-banner-mobile.jpg" id="top-image" class="img-fluid w-33" alt="">';
					html += '<a href="#nav" class="meanmenu-reveal" style="' + meanStyles + '">Show Navigation</a>';
					html += '<nav class="mean-nav"></nav>';
					html += '</div>';
					$('.mean-container').prepend(html);
