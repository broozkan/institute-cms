        ...
        <>
            <li class="nav-item dropdown user-profile-nav-item">
                ...
                <div class="dropdown-menu">
                    <a href="/user/profile" class="dropdown-item"> <span className="fa fa-user"></span> Profilim</a>
                    <a href={siteUrls.USER_DASHBOARD_VIEW} class="dropdown-item"> <span className="fa fa-cogs"></span> Kullanıcı İşlemleri</a>
                    <a href="/user/logout" class="dropdown-item"><span className="fa fa-sign-out"></span> Oturumumu Kapat</a>
                </div>
            </li>
